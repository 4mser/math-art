...
//   toggleButton = createButton("Ocultar elementos");
//   toggleButton.class('toggle-config');
//   toggleButton.mousePressed(() => {
//     elementsVisible = !elementsVisible;
//     slider.style('display', elementsVisible ? 'block' : 'none');
//     rotateButton.style('display', elementsVisible ? 'block' : 'none');
//     dragRotateButton.style('display', elementsVisible ? 'block' : 'none');
//     toggleButton.html(elementsVisible ? 'Ocultar elementos' : 'Mostrar elementos');
//   });
// }
